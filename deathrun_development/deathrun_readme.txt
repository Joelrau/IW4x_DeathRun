...
BUG REPORTS	: Discord: quaK#0426
DISCUSSION	: pm me on discord
TUTORIALS	: google
PLUGINS 	: example can be found in plugins\example.gsc
...
2.0 [xx.xx.xxxx]
[INFO] Ported the mod from cod4 to MW2 IW4x
[+] Added some mw2 special items and stuff.
[-] Removed a lot of things due to modbuilder issues and whatnot.
