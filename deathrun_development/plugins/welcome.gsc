...
init( modVersion )
{
	braxi\_dvar::addDvar( "welcome_message1", "welcome_message1", "Welcome to ^1[YOUR SERVER NAME]", "", "", "string" );
	braxi\_dvar::addDvar( "welcome_message2", "welcome_message2", "^3Visit [YOUR SERVER WEBSITE]", "", "", "string" );
